// ignore_for_file: prefer_const_constructors, curly_braces_in_flow_control_structures, use_key_in_widget_constructors, library_private_types_in_public_api
import 'package:youlearn2/theme/config.dart' as config;
import 'package:youlearn2/ui/pages/home.dart';
import 'package:flutter/material.dart';
import 'package:youlearn2/ui/pages/navmenu/dashboard.dart';
      ...
      body: Stack(
        children: <Widget>[
          ...
          Dashboard(
            ...
            child: Home(onMenuTap: onMenuTap, title: '', builder: (context) {  },),
          ),
        ],
      ),
    );
